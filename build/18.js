...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__restaurant_details__ = __webpack_require__(799);
...
var RestaurantDetailsPageModule = /** @class */ (function () {
...
var RestaurantDetailsPage = /** @class */ (function () {
    function RestaurantDetailsPage(navCtrl, navParams, restaurantProvider, hotelProvider, toolsProvider, reservationProvider, alertCtrl, notificationProvider) {
        ...
        this.dishesList = []; // to store dishes data
    ...
    RestaurantDetailsPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        ...
        var i = 0;
        for (var _i = 0, _a = this.itemData.availableDishes; _i < _a.length; _i++) {
            var item = _a[_i];
    ...
    RestaurantDetailsPage.prototype.fnBack = function () {
        this.navCtrl.pop({ animate: true, animation: 'transition', duration: 500, direction: 'back' });
    };
    //moves to next slide
    RestaurantDetailsPage.prototype.slideNext = function () {
        this.slides.slideNext();
    };
    //moves to previous slide
    RestaurantDetailsPage.prototype.slidePrev = function () {
        this.slides.slidePrev();
    };
    RestaurantDetailsPage.prototype.fnGotoRestaurantBooking = function (item) {
        var _this = this;
