...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WellnessPaymentPageModule", function() { return WellnessPaymentPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wellness_payment__ = __webpack_require__(821);
...
var WellnessPaymentPageModule = /** @class */ (function () {
    function WellnessPaymentPageModule() {
    }
    WellnessPaymentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__wellness_payment__["a" /* WellnessPaymentPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__wellness_payment__["a" /* WellnessPaymentPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], WellnessPaymentPageModule);
    return WellnessPaymentPageModule;
}());

//# sourceMappingURL=wellness-payment.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WellnessPaymentPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_stripe__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_device_service_device_service__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_wellness_service_wellness_service__ = __webpack_require__(183);
...
/**
 * Generated class for the WellnessPaymentPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var WellnessPaymentPage = /** @class */ (function () {
    function WellnessPaymentPage(navCtrl, navParams, formBuilder, toolsProvider, sanitized, reservationProvider, loadingCtrl, stripeService, deviceProvider, alertCtrl, commonProvider, cdRef, wellnessProvider, notificationProvider) {
        ...
        this.wellnessPaymentForm = formBuilder.group({
    ...
    WellnessPaymentPage.prototype.ionViewWillEnter = function () {
        this.showBackButton = true;
    };
    WellnessPaymentPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        console.log('ionViewDidLoad WellnessPaymentPage');
        this.showLoading();
        var me = this;
    ...
    WellnessPaymentPage.prototype.ionViewWillLeave = function () {
        if (this.commonProvider.objFormData.wellness.bookingCompleted != true) {
            this.commonProvider.objFormData.wellness.cardHolder = this.wellnessPaymentForm.get('cardHolder').value;
            this.commonProvider.objFormData.wellness.agreeTerms = this.isChecked;
        }
        this.showBackButton = false;
    };
    // fetch pre-entered data into fields from model
    WellnessPaymentPage.prototype.fnCheckPreEnteredFormData = function () {
        if (this.commonProvider.objFormData && this.commonProvider.objFormData.wellness) {
            ...
            if (this.commonProvider.objFormData.wellness.id == this.item.id) {
                this.wellnessPaymentForm.get("cardHolder").setValue(this.commonProvider.objFormData.wellness.cardHolder);
                this.isChecked = this.commonProvider.objFormData.wellness.agreeTerms;
            }
        }
    };
    //Loader
    WellnessPaymentPage.prototype.showLoading = function () {
        this.loading = this.loadingCtrl.create({
            spinner: 'crescent'
        });
        this.loading.present();
    };
    WellnessPaymentPage.prototype.fnOnRadioSelect = function ($event) {
        this.isChecked = !this.isChecked;
    };
    WellnessPaymentPage.prototype.fnBack = function () {
        this.navCtrl.pop({ animate: true, animation: 'transition', duration: 500, direction: 'back' });
    };
    WellnessPaymentPage.prototype.fnSubmit = function () {
        var _this = this;
        if (this.wellnessPaymentForm.controls['cardHolder'].hasError('required')) {
            ...
            if (this.card != null && this.card != undefined) {
                this.showLoading();
                //create stripe token
                this.commonProvider.objServiceForm.cardHolder = this.wellnessPaymentForm.get('cardHolder').value;
                var name_1 = this.wellnessPaymentForm.get('cardHolder').value;
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (data) {
                                            _this.showLoading();
                                            var serviceId = _this.commonProvider.objServiceForm.serviceId, date = _this.commonProvider.objServiceForm.date, turn = _this.commonProvider.objServiceForm.turn > 0 ? _this.commonProvider.objServiceForm.turn : 0, noOfPersons = _this.commonProvider.objServiceForm.noOfPersons, comments = _this.commonProvider.objServiceForm.comments, cardholder = _this.wellnessPaymentForm.get('cardHolder').value, token = result.token.id, reservationId = _this.reservationProvider.objReservation.reservationId, itemServiceId = _this.item.servicioSaludId;
                                            // service call for reservation booking with payment
                                            _this.wellnessProvider.sendServiceWellnessWithPayment(reservationId, serviceId, date, turn, noOfPersons, comments, cardholder, token, itemServiceId).subscribe(function (data) {
                                                _this.loading.dismiss();
                                                if (data.success == true) {
    ...
    WellnessPaymentPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */],
            ...
            __WEBPACK_IMPORTED_MODULE_8__providers_reservation_service_reservation_service__["a" /* ReservationServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */],
            __WEBPACK_IMPORTED_MODULE_5_ngx_stripe__["b" /* StripeService */], __WEBPACK_IMPORTED_MODULE_6__providers_device_service_device_service__["a" /* DeviceServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_7__providers_common_service_common_service__["a" /* CommonServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectorRef */], __WEBPACK_IMPORTED_MODULE_9__providers_wellness_service_wellness_service__["a" /* WellnessServiceProvider */], __WEBPACK_IMPORTED_MODULE_10__providers_notification_notification__["a" /* NotificationProvider */]])
    ], WellnessPaymentPage);
    return WellnessPaymentPage;
}());

//# sourceMappingURL=wellness-payment.js.map
