...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WellnessPageModule", function() { return WellnessPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wellness__ = __webpack_require__(811);
...
var WellnessPageModule = /** @class */ (function () {
    function WellnessPageModule() {
    }
    WellnessPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__wellness__["a" /* WellnessPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__wellness__["a" /* WellnessPage */]),
...
//# sourceMappingURL=wellness.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WellnessPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_wellness_service_wellness_service__ = __webpack_require__(183);
 ...
 */
var WellnessPage = /** @class */ (function () {
    function WellnessPage(transfer, file, navCtrl, navParams, wellnessProvider, toolsProvider, menuCtrl, loadingCtrl, notificationProvider, platForm) {
        ...
        if (this.wellnessProvider.objWellness && this.wellnessProvider.objWellness.activeSlider) {
            this.activeSlider = this.wellnessProvider.objWellness.activeSlider;
        }
        //get wellness list
        this.wellnessList = this.wellnessProvider.objWellness.data;
    }
    WellnessPage.prototype.ionViewWillLeave = function () {
        //save active slider index
        this.wellnessProvider.objWellness.activeSlider = this.slides.getActiveIndex();
    };
    WellnessPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    //moves to next slide
    WellnessPage.prototype.slideNext = function () {
        this.slides.slideNext();
    };
    //moves to previous slide
    WellnessPage.prototype.slidePrev = function () {
        this.slides.slidePrev();
    };
    WellnessPage.prototype.download = function (itemId, url, fname, i) {
        var _this = this;
        this.file.checkFile(this.file.cacheDirectory, fname).then(function () {
            ...
            _this.navCtrl.push("WellnessDetailsPage", { itemId: itemId, img: imgUrl }, { animate: true, animation: 'transition', duration: 500, direction: 'forward' });
        }, function (error) {
            ...
            fileTransfer.download(url, _this.file.cacheDirectory + fname).then(function (entry) {
                ...
                _this.loading.dismiss();
                _this.navCtrl.push("WellnessDetailsPage", { itemId: itemId, img: "" }, { animate: true, animation: 'transition', duration: 500, direction: 'forward' });
            });
        });
    };
    WellnessPage.prototype.fnGotoDetailsPage = function (itemId) {
        this.showLoading();
        var itemData = this.wellnessProvider.objWellness.data; // get all item list
        itemData = itemData.find(function (x) { return x.id == itemId; }); // get item from item list with given item id
        for (var _i = 0, _a = itemData.availableItems; _i < _a.length; _i++) {
            var item = _a[_i];
    ...
    WellnessPage.prototype.fnBack = function () {
        this.navCtrl.pop({ animate: true, animation: 'transition', duration: 500, direction: 'back' });
    };
    // slide changed
    WellnessPage.prototype.slideChanged = function () {
        this.wellnessProvider.objWellness.activeSlider = this.slides.getActiveIndex();
    };
    //Loader
    WellnessPage.prototype.showLoading = function () {
    ...
    WellnessPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__ionic_native_file_transfer__["a" /* FileTransfer */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__["a" /* File */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_wellness_service_wellness_service__["a" /* WellnessServiceProvider */], __WEBPACK_IMPORTED_MODULE_3__providers_tools_tools__["a" /* ToolsProvider */],
