...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RestaurantPaymentPageModule", function() { return RestaurantPaymentPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__restaurant_payment__ = __webpack_require__(819);
...
var RestaurantPaymentPageModule = /** @class */ (function () {
    function RestaurantPaymentPageModule() {
    }
    RestaurantPaymentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__restaurant_payment__["a" /* RestaurantPaymentPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__restaurant_payment__["a" /* RestaurantPaymentPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], RestaurantPaymentPageModule);
    return RestaurantPaymentPageModule;
}());

//# sourceMappingURL=restaurant-payment.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RestaurantPaymentPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ngx_stripe__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_device_service_device_service__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_common_service_common_service__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_restaurant_service_restaurant_service__ = __webpack_require__(182);
 ...
 */
var RestaurantPaymentPage = /** @class */ (function () {
    function RestaurantPaymentPage(navCtrl, navParams, formBuilder, toolsProvider, sanitized, reservationProvider, loadingCtrl, stripeService, deviceProvider, alertCtrl, commonProvider, cdRef, restaurantProvider, notificationProvider) {
    ...
    RestaurantPaymentPage.prototype.ionViewWillEnter = function () {
        this.showBackButton = true;
    };
    RestaurantPaymentPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.showLoading();
        var me = this;
    ...
    RestaurantPaymentPage.prototype.ionViewWillLeave = function () {
    ...
    RestaurantPaymentPage.prototype.fnCheckPreEnteredFormData = function () {
    ...
    //Loader
    RestaurantPaymentPage.prototype.showLoading = function () {
        this.loading = this.loadingCtrl.create({
            spinner: 'crescent'
        });
        this.loading.present();
    };
    RestaurantPaymentPage.prototype.fnSubmit = function () {
        var _this = this;
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (data) {
                                            ...
                                            _this.restaurantProvider.sendServiceReservationWithPayment(reservationId, serviceId, date, turn, noOfPersons, comments, cardholder, token).subscribe(function (data) {
                                                _this.loading.dismiss();
                                                if (data.success == true) {
