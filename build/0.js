...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WellnessBookingPageModule", function() { return WellnessBookingPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wellness_booking__ = __webpack_require__(821);
...
var WellnessBookingPageModule = /** @class */ (function () {
    function WellnessBookingPageModule() {
    }
    WellnessBookingPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__wellness_booking__["a" /* WellnessBookingPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__wellness_booking__["a" /* WellnessBookingPage */]),
                __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["b" /* TranslateModule */].forChild()
            ],
        })
    ], WellnessBookingPageModule);
    return WellnessBookingPageModule;
}());

//# sourceMappingURL=wellness-booking.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WellnessBookingPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__model_service_form_model__ = __webpack_require__(788);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_wellness_service_wellness_service__ = __webpack_require__(183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_hotel_service_hotel_service__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_notification_notification__ = __webpack_require__(41);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/**
 * Generated class for the WellnessBookingPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var WellnessBookingPage = /** @class */ (function () {
    function WellnessBookingPage(navCtrl, navParams, formBuilder, toolsPvdr, sanitized, commonProvider, reservationProvider, alertCtrl, cdRef, wellnessProvider, hotelProvider, notificationProvider, loadingCtrl, platForm) {
        var _this = this;
        ...
        this.wellnessBookingForm = this.formBuilder.group({
    ...
    WellnessBookingPage.prototype.ionViewWillEnter = function () {
        this.showBackButton = true;
    };
    WellnessBookingPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad WellnessBookingPage');
        ...
        this.wellnessBookingForm.get("noOfPersons").setValue(this.item.modoReserva.minPersonas); // set minimum number of person as default value
    ...
    WellnessBookingPage.prototype.ionViewWillLeave = function () {
        if (this.commonProvider.objFormData.wellness.bookingCompleted != true) {
            this.commonProvider.objFormData.wellness.id = this.item.id;
            this.commonProvider.objFormData.wellness.date = this.wellnessBookingForm.get('date').value;
            this.commonProvider.objFormData.wellness.time = this.wellnessBookingForm.controls['time'] && this.wellnessBookingForm.get('time').value;
            this.commonProvider.objFormData.wellness.turn = this.wellnessBookingForm.controls['turn'] && this.wellnessBookingForm.get('turn').value;
            this.commonProvider.objFormData.wellness.noOfPersons = this.wellnessBookingForm.get('noOfPersons').value;
            this.commonProvider.objFormData.wellness.comments = this.wellnessBookingForm.get('specialRequests').value;
            this.commonProvider.objFormData.wellness.bookingCompleted = false;
        }
        this.showBackButton = false;
    };
    // fetch pre-entered data into fields from model
    WellnessBookingPage.prototype.fnCheckPreEnteredFormData = function () {
        if (this.commonProvider.objFormData && this.commonProvider.objFormData.wellness) {
            this.commonProvider.objFormData.wellness.bookingCompleted = false;
            if (this.commonProvider.objFormData.wellness.id == this.item.id) {
                this.wellnessBookingForm.get("date").setValue(this.commonProvider.objFormData.wellness.date);
                this.wellnessBookingForm.controls['time'] && this.wellnessBookingForm.get("time").setValue(this.commonProvider.objFormData.wellness.time);
                this.wellnessBookingForm.controls['turn'] && this.wellnessBookingForm.get("turn").setValue(this.commonProvider.objFormData.wellness.turn);
                this.wellnessBookingForm.get("noOfPersons").setValue(this.commonProvider.objFormData.wellness.noOfPersons);
                this.wellnessBookingForm.get("specialRequests").setValue(this.commonProvider.objFormData.wellness.comments);
            }
        }
    };
    //function to go to previous page
    WellnessBookingPage.prototype.fnBack = function () {
        this.navCtrl.pop({ animate: true, animation: 'transition', duration: 500, direction: 'back' });
    };
    WellnessBookingPage.prototype.fnDateChange = function () {
        var date = this.toolsPvdr.fnDateFormatChange(this.wellnessBookingForm.controls['date'] && new Date(this.wellnessBookingForm.get('date').value));
        var isToday;
    ...
    WellnessBookingPage.prototype.fnSubmit = function (item) {
        var _this = this;
        if (this.wellnessBookingForm.controls['date'].hasError('required')) {
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            handler: function (data) {
                                ...
                                var bookingDate;
                                var time = _this.wellnessBookingForm.controls['time'] && _this.wellnessBookingForm.get('time').value ? _this.wellnessBookingForm.get('time').value + ':00' : '00:00:00';
                                bookingDate = _this.toolsPvdr.dateFormatChangeForService(_this.wellnessBookingForm.controls['date'] && new Date(_this.wellnessBookingForm.get('date').value)).split(" ")[0] + ' ' + time;
                                if ((item.paymentRequiredNoStay && _this.reservationProvider.objReservation.noStayGuest) || (item.paymentRequired && !_this.reservationProvider.objReservation.noStayGuest)) {
                                    ...
                                    _this.commonProvider.objServiceForm.turn = _this.wellnessBookingForm.controls['turn'] && _this.wellnessBookingForm.get('turn').value ? _this.wellnessBookingForm.get('turn').value : '';
                                    _this.commonProvider.objServiceForm.noOfPersons = _this.wellnessBookingForm.get('noOfPersons').value;
                                    _this.commonProvider.objServiceForm.comments = _this.wellnessBookingForm.get('specialRequests').value;
                                    _this.navCtrl.push("WellnessPaymentPage", { item: item }, { animate: true, animation: 'transition', duration: 500, direction: 'forward' });
                                }
                                else {
                                    // if payment required is false 
                                    _this.showLoading();
                                    console.log(_this.wellnessBookingForm.get('noOfPersons').value);
                                    var serviceId = item.id;
                                    var date = bookingDate;
                                    var itemServiceId = item.servicioSaludId;
                                    var turn = _this.wellnessBookingForm.controls['turn'] && _this.wellnessBookingForm.get('turn').value ? _this.wellnessBookingForm.get('turn').value : '', person = _this.wellnessBookingForm.get('noOfPersons').value, comments = _this.wellnessBookingForm.get('specialRequests').value, reservationId = _this.reservationProvider.objReservation.reservationId;
                                    _this.wellnessProvider.sendWellnessReservation(serviceId, date, turn, person, comments, reservationId, itemServiceId).subscribe(function (data) {
                                        _this.loading.dismiss();
                                        if (data.success == true) {
                                            _this.wellnessBookingForm.reset();
                                            _this.commonProvider.objFormData.wellness = [];
                                            _this.commonProvider.objFormData.wellness.bookingCompleted = true;
    ...
    WellnessBookingPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */],
            ...
            __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectorRef */], __WEBPACK_IMPORTED_MODULE_8__providers_wellness_service_wellness_service__["a" /* WellnessServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_9__providers_hotel_service_hotel_service__["a" /* HotelServiceProvider */], __WEBPACK_IMPORTED_MODULE_10__providers_notification_notification__["a" /* NotificationProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */]])
    ], WellnessBookingPage);
    return WellnessBookingPage;
}());

//# sourceMappingURL=wellness-booking.js.map
